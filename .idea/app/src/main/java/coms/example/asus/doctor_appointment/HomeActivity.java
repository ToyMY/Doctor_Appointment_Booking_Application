        ...
        implements NavigationView.OnNavigationItemSelectedListener
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ProductsRef = FirebaseDatabase.getInstance().getReference().child("Doctors");
    ...
    protected void onStart()
    {
        ...
        FirebaseRecyclerOptions<Doctors> options =
                new FirebaseRecyclerOptions.Builder<Doctors>()
                        .setQuery(ProductsRef, Doctors.class)
                        .build();
        ...
        FirebaseRecyclerAdapter<Doctors, DoctorViewHolder> adapter =
                new FirebaseRecyclerAdapter<Doctors, DoctorViewHolder>(options) {
                    ...
                    protected void onBindViewHolder(@NonNull DoctorViewHolder holder, int position, @NonNull Doctors model)
                    {
                        ...
                        holder.txtDoctorDescription.setText(model.getSpeciality());
...
//        }
    ...
    public boolean onNavigationItemSelected(MenuItem item)
    {
        ...
        if (id == R.id.nav_share)
        {
            ...
            String body = "This is very useful app to appointment doctor without going hospital.\n com.example.doctorappointment";
